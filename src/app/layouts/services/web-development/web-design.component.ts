...
import { TechListComponent, TechBadge } from '../../../shared/tech-list/tech-list.component';
import { FaqComponent, FaqCategory } from '../../../shared/faq/faq.component';
import { ContactFormComponent } from '../../../shared/contact-form/contact-form.component';

@Component({
  selector: 'app-web-design',
  standalone: true,
  imports: [HeroSectionComponent, TechListComponent, FaqComponent, ContactFormComponent],
  templateUrl: './web-design.component.html',
  styleUrls: ['./web-design.component.scss']
})

export class WebDesignComponent implements AfterViewInit {
  ...
  setupCircleAnimation() {
    // Configurar el Intersection Observer para animar los círculos cuando son visibles
    const circles = document.querySelectorAll('.feature-circle[data-animate="true"]');
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          // Añadir la clase animate cuando el círculo es visible
      ...
      threshold: 0.5, // Animar cuando al menos el 50% del elemento es visible
      rootMargin: '0px 0px -100px 0px' // Activar un poco antes de que el elemento sea completamente visible
    });

    // Observar todos los círculos
